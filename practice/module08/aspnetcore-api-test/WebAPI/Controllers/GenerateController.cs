...
namespace WebAPI.Controllers
{
    ...
    //[ApiController]
    //[Route("[controller]")] //weather controllerr
    // Just use action name as route
    [Route("[action]")]
    public class GenerateController : ControllerBase
    {
        //public const string MAIL_HOST = "localhost"; // use it if you run in host machine
        public const string MAIL_HOST = "mail"; //call by the service name if it is runnin in the container
